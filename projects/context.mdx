...
## Overview
Research context tells Aseed what you want to learn and how interviews should run. Aseed uses this context in report generation.
...
The AI Agent can build a Research Context Brief by asking focused questions about your project.
